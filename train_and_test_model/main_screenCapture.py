...
def run_scanner(mode="webcam", target_window_title=None):
    ...
    # Cửa sổ hiển thị AI: Để chế độ tự do để người dùng tự kéo đi chỗ khác
    cv2.namedWindow("HUIT Deepfake Scanner", cv2.WINDOW_NORMAL)
    cv2.resizeWindow("HUIT Deepfake Scanner", 400, 350)
    cv2.moveWindow("HUIT Deepfake Scanner", 800, 50)
